...
const CartProductItem = ({ cartItem, removeFromCart }: ChildProps) => {
  ...
  return (
    <div className="flex mx-auto shrink-0 bg-white justify-start py-4 my-1 border-b border-b-sypher-light-border border-t border-t-sypher-light-border text-black items-center flex-col w-full min-h-113 bg-sypher-compGray">
