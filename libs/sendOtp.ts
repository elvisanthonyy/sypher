...
export async function sendOTP(email: string, otp: string) {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<div style="width: 100%; display: flex; flex-direction: column; height: 100px; align-items: center;"><h2 style="font: bold; margin-bottom: 30px; color: #03a3ff;"> UC DOM </h2>
