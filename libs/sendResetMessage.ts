...
export async function sendResetMessage(email: string, resetToken: string) {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<div style="width: 100%; display: flex; height: 500px; flex-direction: column; align-items: center;"><h2 style="font: bold; margin-bottom: 30px; color: #03a3ff;"> UC DOM </h2>
